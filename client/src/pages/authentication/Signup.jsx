...
const Signup = () => {
  ...
  const dispatch = useDispatch();
   ...
   const [signupData, setSignupData] = useState({
      ...
      const handleSignup = async () => {
        if (parseInt(signupData.password)!== parseInt(signupData.confirmPassword)) {
  ...
  return (
    ...
    <div className="max-w-[40rem] w-full flex flex-col gap-5 bg-base-200 p-6 rounded-lg justify-center items-center">
